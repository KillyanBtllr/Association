...
<body>
    <div class="login">
        ...
        <form class="login-container" action="../../api.php" method="POST">
            <input type="hidden" name="action" value="ajout_activite">
            <p><input type="text" name="nom_act" placeholder="Nom de l'activité"></p>
            <p><input type="text" name="desc_act" placeholder="Description"></p>
            <p>Responsable :
